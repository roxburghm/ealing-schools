<template>
    <v-app class="fill-height">
           ...
           <school-list :year="year" v-model="schools" @home="newVal => home = newVal"/>
            ...
            <v-app-bar app color="secondary" dark>
                ...
                <v-btn class="mr-2" v-for="showYear in years" :key="showYear"
                       @click="year = showYear"
                       :color="showYear === year ? 'primary' : 'grey'">{{ showYear }}</v-btn>
                </v-layout>
            ...
            <v-card>
                ...
                <v-card-text class="pt-4">
                    <p>All intake information is based on data in the
                        <a target="_blank" href="https://viewer.joomag.com/high-school-prospectus-2022/0579981001629885520">Starting High School 2022</a>,
                        <a target="_blank" href="https://www.ealing.gov.uk/download/downloads/id/13820/high_school_prospectus_202122.pdf">Starting High School 2021</a> and
                    ...
                    <p>Enter your address in the box in the top left to see your home on the map, click schools in the left panel to enable or disable their zones.</p>

                    <p><em>Privacy: NO DATA IS COLLECTED WHEN USING THIS APPLICATION. IT ALL STAYS LOCALLY ON YOUR MACHINE.</em></p>
        ...
        <v-dialog v-model="showSchoolInfo" width="500">
